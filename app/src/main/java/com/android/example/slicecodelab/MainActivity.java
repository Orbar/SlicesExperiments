...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static boolean sLiked = false;
    ...
    public static void like(Context context, boolean value) {
        sLiked = value;

        Toast.makeText(context, (sLiked ? "Like" : "Unlike") + " Post", Toast.LENGTH_SHORT).show();
    ...
    public static void reblog(Context context) {
        Toast.makeText(context, "Reblog Post", Toast.LENGTH_SHORT).show();
